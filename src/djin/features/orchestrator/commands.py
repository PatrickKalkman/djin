...
def overview_command(args: List[str]) -> bool:
    ...
    try:
        ...
        console.print(f"[bold red]An unexpected error occurred while fetching the overview.[/bold red]")
        return False
...
def work_summary_command(args: List[str]) -> bool:
    ...
    try:
        ...
        console.print(f"[bold red]An unexpected error occurred while generating the work summary.[/bold red]")
        return False # Indicate command failure
